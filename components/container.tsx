...
export default function Container(props) {
  ...
  const router = useRouter();
  const meta = {
    title: 'Brody MacLean – Principal Product Designer',
    description: `Multi-disciplinary product designer.`,
    // image: 'https://brody.com/static/images/banner.png',
    type: 'website',
    ...customMeta,
  };
  ...
  return (
    <div className='bg-gray-900'>
      <Head>
        ...
        <meta property='og:url' content={`https://brody.com${router.asPath}`} />
        <link rel='canonical' href={`https://brody.com${router.asPath}`} />
